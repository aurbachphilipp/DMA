...
set id 29
set name dma_demo_v_tpg_0_2_mul_8ns_6ns_13_1_1
...
set id 30
set name dma_demo_v_tpg_0_2_mul_mul_17s_16ns_32_4_1
set corename simcore_mul
set op mul
set stage_num 4
set max_latency -1
...
set id 31
set name dma_demo_v_tpg_0_2_mac_muladd_8ns_8ns_14ns_15_4_1
...
set out_width 15
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {8 0 +} m {15 0 +} i2 {14 0 +} p {15 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set id 32
set name dma_demo_v_tpg_0_2_mac_muladd_8ns_8s_16s_16_4_1
set corename simcore_mac
set op mac
set stage_num 4
set max_latency -1
...
set id 33
set name dma_demo_v_tpg_0_2_mac_muladd_8ns_8s_15ns_16_4_1
set corename simcore_mac
set op mac
set stage_num 4
set max_latency -1
...
set id 34
set name dma_demo_v_tpg_0_2_mac_muladd_8ns_9ns_15ns_16_4_1
set corename simcore_mac
set op mac
set stage_num 4
set max_latency -1
...
set id 35
set name dma_demo_v_tpg_0_2_mac_muladd_8ns_7s_16s_16_4_1
set corename simcore_mac
set op mac
set stage_num 4
set max_latency -1
...
set id 36
set name dma_demo_v_tpg_0_2_mac_muladd_16s_16s_16ns_16_4_1
set corename simcore_mac
set op mac
set stage_num 4
set max_latency -1
...
set id 37
set name dma_demo_v_tpg_0_2_mul_mul_20s_9ns_28_4_1
set corename simcore_mul
set op mul
set stage_num 4
set max_latency -1
...
set out_width 28
set exp i0*i1
set arg_lists {i0 {20 1 +} i1 {9 0 +} p {28 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
set id 38
set name dma_demo_v_tpg_0_2_mac_muladd_8ns_6s_16s_16_4_1
set corename simcore_mac
set op mac
set stage_num 4
set max_latency -1
...
set ID 49
set hasByteEnable 0
set MemName dma_demo_v_tpg_0_2_tpgBackground_redYuv
...
set ID 50
set hasByteEnable 0
set MemName dma_demo_v_tpg_0_2_tpgBackground_grnYuv
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 8
set AddrRange 3
...
set ID 51
set hasByteEnable 0
set MemName dma_demo_v_tpg_0_2_tpgBackground_bluYuv
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 8
set AddrRange 3
...
set ID 52
set hasByteEnable 0
set MemName dma_demo_v_tpg_0_2_tpgBackground_tpgBarSelYuv_y
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 8
set AddrRange 8
...
set ID 53
set hasByteEnable 0
set MemName dma_demo_v_tpg_0_2_tpgBackground_tpgBarSelYuv_v
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 8
set AddrRange 8
...
set ID 54
set hasByteEnable 0
set MemName dma_demo_v_tpg_0_2_tpgBackground_tpgBarSelYuv_u
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 8
set AddrRange 8
...
set ID 55
set hasByteEnable 0
set MemName dma_demo_v_tpg_0_2_tpgBackground_tpgSinTableArray
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 20
set AddrRange 2048
...
set ID 56
set hasByteEnable 0
set MemName dma_demo_v_tpg_0_2_tpgBackground_tpgTartanBarArray
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 3
set AddrRange 64
...
set ID 57
set hasByteEnable 0
set MemName dma_demo_v_tpg_0_2_tpgBackground_tpgSinTableArray_9bit
set CoreName ap_simcore_mem
set PortList { 1 1 1 }
set DataWd 9
set AddrRange 2048
...
set ID 58
set hasByteEnable 0
set MemName dma_demo_v_tpg_0_2_tpgBackground_tpgCheckerBoardArray
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 2
set AddrRange 32
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_bck_motion_en \
    op interface \
    ports { bck_motion_en { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_patternId \
    op interface \
    ports { patternId { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_outImg \
    op interface \
    ports { outImg_din { O 24 vector } outImg_full_n { I 1 bit } outImg_write { O 1 bit } } \
} "
}
